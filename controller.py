...
LIGHTSALMON = (255, 204, 255)
SPRINGGREEN = (255, 102, 0)
ORANGE = (210, 105, 30)
ORCHID = (218, 112, 214)
...
class Controller:
    ...
    def end_round(self):
        print('end')
        rect = self.representor.congratulations()
    ...
    def game_loop(self):
        ...
        print(self.name)
        while True:
            self.num_of_bottles = self.representor.new_game_window(self.name)
            print(self.num_of_bottles)
